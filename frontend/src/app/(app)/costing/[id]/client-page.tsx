...
/**
 * Costing Card Detail/Edit — Single card view (client side)
 *
...
export default function CostingCardDetailClientPage() {
  ...
  const fetchCard = useCallback(async () => {
    // 'placeholder' is the static-export shell slug; never fetch for it.
