...
export function ExpenseSupplies({ size = 40, className }: IllustrationProps) {
  return (
    ...
    >
      {/* Box body */}
      <rect x="6" y="16" width="28" height="18" rx="2" fill="hsl(var(--primary-container))" stroke="hsl(var(--on-surface))" strokeWidth="1.2" opacity="0.7" />
      {/* Box front face darker shade */}
      <rect x="6" y="24" width="28" height="10" rx="1" fill="#d97706" opacity="0.7" />
      {/* Box flap left */}
      <path
      ...
      />
      {/* Gap between flaps */}
      <rect x="18" y="10" width="4" height="6" fill="hsl(var(--on-surface))" opacity="0.8" />
      ...
      <circle cx="18" cy="8" r="3" fill="hsl(var(--on-surface))" opacity="0.7" />
      <circle cx="18" cy="8" r="1.5" fill="hsl(var(--surface-container))" />
      {/* Box tape strip */}
      <rect x="18" y="16" width="4" height="10" rx="0.5" fill="#fbbf24" opacity="0.7" />
    </svg>
  );
}
