...
export function ExpenseTransport({ size = 40, className }: IllustrationProps) {
  return (
    ...
    >
      {/* Jeepney body */}
      <rect x="5" y="14" width="30" height="14" rx="2" fill="hsl(var(--primary-container))" stroke="hsl(var(--on-surface))" strokeWidth="1.2" opacity="0.7" />
      {/* Jeepney roof */}
      ...
      {/* Rear opening */}
      <rect x="31" y="17" width="3" height="8" rx="0.5" fill="hsl(var(--on-surface))" opacity="0.7" />
      {/* Left wheel */}
      ...
      {/* Ground line */}
      <rect x="3" y="32.5" width="34" height="1" rx="0.5" fill="hsl(var(--on-surface))" opacity="0.7" />
    </svg>
  );
}
