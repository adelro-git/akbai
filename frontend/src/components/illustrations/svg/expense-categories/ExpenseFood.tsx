...
export function ExpenseFood({ size = 40, className }: IllustrationProps) {
  return (
    ...
    >
      ...
      {/* Bowl base */}
      <rect x="16" y="28" width="8" height="2" rx="1" fill="hsl(var(--on-surface))" opacity="0.4" />
      {/* Spoon */}
      <path
      ...
      {/* Steam wisps */}
      <path d="M16 10C16 8.5 17 7 16.5 5.5" stroke="hsl(var(--on-surface))" strokeWidth="0.8" strokeLinecap="round" opacity="0.45" fill="none" />
      <path d="M20 9C20 7.5 21 6 20.5 4.5" stroke="hsl(var(--on-surface))" strokeWidth="0.8" strokeLinecap="round" opacity="0.45" fill="none" />
      <path d="M24 10C24 8.5 25 7 24.5 5.5" stroke="hsl(var(--on-surface))" strokeWidth="0.8" strokeLinecap="round" opacity="0.45" fill="none" />
    </svg>
  );
}
