...
export function ExpenseEquipment({ size = 40, className }: IllustrationProps) {
  return (
    ...
    >
      ...
      {/* Screwdriver tip */}
      <rect x="28" y="26" width="1.5" height="4" rx="0.3" fill="hsl(var(--on-surface))" opacity="0.7" transform="rotate(-30 28.75 28)" />
      {/* Screwdriver handle grip lines */}
      <rect x="33" y="32" width="1.8" height="0.8" rx="0.2" fill="hsl(var(--surface-container))" opacity="0.7" transform="rotate(-30 33.9 32.4)" />
      <rect x="33.5" y="33.5" width="1.8" height="0.8" rx="0.2" fill="hsl(var(--surface-container))" opacity="0.7" transform="rotate(-30 34.4 33.9)" />
    </svg>
  );
}
