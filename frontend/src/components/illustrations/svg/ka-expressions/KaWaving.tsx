...
export function KaWaving({ size = 48, className }: IllustrationProps) {
  return (
    ...
    >
      ...
      {/* Motion lines */}
      <path d="M41 10L43 8" stroke="#d97706" strokeWidth="1.2" strokeLinecap="round" opacity="0.8" fill="none" />
      <path d="M42 14L44 13" stroke="#d97706" strokeWidth="1.2" strokeLinecap="round" opacity="0.8" fill="none" />
      <path d="M41 18L43 18" stroke="#d97706" strokeWidth="1.2" strokeLinecap="round" opacity="0.8" fill="none" />
    </svg>
  );
}
