...
export function KaCelebrating({ size = 48, className }: IllustrationProps) {
  return (
    ...
    >
      {/* Confetti pieces */}
      <rect x="6" y="6" width="3" height="3" rx="0.5" fill="#f59e0b" transform="rotate(15 7.5 7.5)" />
      <rect x="40" y="4" width="2.5" height="2.5" rx="0.5" fill="hsl(var(--tertiary))" transform="rotate(-20 41 5)" />
      <rect x="3" y="20" width="2" height="2" rx="0.5" fill="#fbbf24" opacity="0.8" transform="rotate(30 4 21)" />
      <rect x="44" y="22" width="2.5" height="2.5" rx="0.5" fill="#d97706" opacity="0.8" transform="rotate(-10 45 23)" />
      <circle cx="8" cy="36" r="1.5" fill="#fbbf24" opacity="0.8" />
      <circle cx="42" cy="36" r="1.2" fill="hsl(var(--tertiary))" opacity="0.8" />
      {/* Golden C-shape body */}
      <path
