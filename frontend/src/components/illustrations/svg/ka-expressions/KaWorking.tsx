...
export function KaWorking({ size = 48, className }: IllustrationProps) {
  return (
    ...
    >
      ...
      {/* Clipboard lines */}
      <rect x="36" y="19" width="6" height="1" rx="0.5" fill="hsl(var(--on-surface))" opacity="0.7" />
      <rect x="36" y="22" width="4" height="1" rx="0.5" fill="hsl(var(--on-surface))" opacity="0.7" />
      <rect x="36" y="25" width="5" height="1" rx="0.5" fill="hsl(var(--on-surface))" opacity="0.7" />
    </svg>
  );
}
