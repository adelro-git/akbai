...
export function MorningBriefing({ size = 64, className }: IllustrationProps) {
  return (
    ...
    >
      ...
      {/* Horizon line */}
      <rect x="6" y="24" width="52" height="1" rx="0.5" fill="hsl(var(--on-surface))" opacity="0.1" />

      {/* Clipboard body */}
      <rect x="14" y="28" width="36" height="32" rx="3" fill="hsl(var(--surface))" />
      <rect x="14" y="28" width="36" height="32" rx="3" stroke="hsl(var(--on-surface))" strokeWidth="0.5" opacity="0.12" />

      {/* Clipboard clip */}
      <rect x="24" y="25" width="16" height="6" rx="2" fill="hsl(var(--surface-container))" />
      <rect x="24" y="25" width="16" height="6" rx="2" stroke="hsl(var(--on-surface))" strokeWidth="0.5" opacity="0.15" />
      <rect x="28" y="26" width="8" height="2" rx="1" fill="hsl(var(--primary-container))" />

      {/* Checklist items */}
      {/* Item 1 - checked */}
      <rect x="19" y="35" width="4" height="4" rx="1" fill="hsl(var(--tertiary))" opacity="0.2" />
      ...
      <rect x="25" y="36" width="18" height="2" rx="1" fill="hsl(var(--on-surface))" opacity="0.15" />

      {/* Item 2 - checked */}
      <rect x="19" y="42" width="4" height="4" rx="1" fill="hsl(var(--tertiary))" opacity="0.2" />
      ...
      <rect x="25" y="43" width="14" height="2" rx="1" fill="hsl(var(--on-surface))" opacity="0.15" />

      {/* Item 3 - unchecked */}
      <rect x="19" y="49" width="4" height="4" rx="1" fill="hsl(var(--surface-container))" />
      <rect x="19" y="49" width="4" height="4" rx="1" stroke="hsl(var(--on-surface))" strokeWidth="0.5" opacity="0.15" fill="none" />
      <rect x="25" y="50" width="20" height="2" rx="1" fill="hsl(var(--on-surface))" opacity="0.12" />

      {/* Item 4 - unchecked */}
      <rect x="19" y="55" width="4" height="4" rx="1" fill="hsl(var(--surface-container))" />
      <rect x="19" y="55" width="4" height="4" rx="1" stroke="hsl(var(--on-surface))" strokeWidth="0.5" opacity="0.15" fill="none" />
      <rect x="25" y="56" width="16" height="2" rx="1" fill="hsl(var(--on-surface))" opacity="0.12" />
    </svg>
  );
}
