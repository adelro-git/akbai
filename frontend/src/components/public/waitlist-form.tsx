    ...
    <div className="w-full max-w-md">
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <button
          ...
          className="min-h-[44px] min-w-[44px] whitespace-nowrap rounded-xl bg-gradient-to-r from-primary-container to-honey-deep px-6 py-3.5 text-sm font-semibold text-white shadow-ambient transition-all hover:shadow-ambient-lg active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
        >
